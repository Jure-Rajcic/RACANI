...
export const FirestoreBytesSchema = z.instanceof(Buffer);
...
// Used for for realtime database because we just want to validate data and nothing append extra fields if we are billed  on bandwidth
