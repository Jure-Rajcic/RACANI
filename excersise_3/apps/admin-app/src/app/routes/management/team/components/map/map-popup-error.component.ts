...
@Component({
  selector: 'app-marker-popup-error',
  templateUrl: './map-popup-error.component.html',
  imports: [DatePipe, HlmSpinnerImports, CommonModule],
  standalone: true,
})
export class MarkerPopupErrorComponent {
  ...
  readonly _error = signal<string | undefined>(undefined);
  @Input({ required: true })
